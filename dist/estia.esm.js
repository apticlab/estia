...
var script$j = {
  ...
  methods: {
    ...
    fetchOptions: async function fetchOptions() {
      ...
      for (var vhIndex = 0; vhIndex < this.visible_headers.length; vhIndex++) {
        var header = this.visible_headers[vhIndex];
    ...
    setDependableVariables: function setDependableVariables() {
      ...
      var depandableHeaders = this.headers.filter(
        function (header) { return header.depends_on; }
      );
